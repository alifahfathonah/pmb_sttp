  ...
  <div class="card <?php echo $this->session->flashdata('error')==null ? 'collapsed-card':'' ?>">
    ...
    <div class="card-body">
      ...
      <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="<?php echo site_url('adminku/jurusan/post') ?>" method='post' enctype="multipart/form-data" >
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input required type="text" class="form-control" value="<?php echo $this->session->flashdata('input') ? $this->session->flashdata('input')['nm_jur'] :'' ?>" name="nm_jur" id="nm_jur" placeholder="Nama Jurusan">
            </div>

            <div class="form-group">
              <label for="sym">Simbol Untuk No Daftar</label>
              <input required type="text" class="form-control" value="<?php echo $this->session->flashdata('input') ? $this->session->flashdata('input')['sym'] :'' ?>" name="sym" id="sym" placeholder="contoh:TI, SE, TE">
            </div>
...
<script>
  ...
  $(document).ready(function() {
    tabel=$('#tableDaftar').DataTable({
      "ajax": {
        url : "<?php echo site_url("adminku/jurusan/getAll")?>",
        type : 'GET'
      }
    });
  });
  function edit(id){
    ...
    $.ajax({
      url: "<?php echo site_url('adminku/jurusan/edit') ?>",
      type:'post',
      data:data,
  ...
  function hapus(id){
    ...
    if (confirm) {
      ...
      $.ajax({
        url: "<?php echo site_url('adminku/jurusan/hapus') ?>",
        type:'post',
        data:data,
        beforeSend:function(){
